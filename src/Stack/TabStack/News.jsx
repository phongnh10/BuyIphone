...
const News = () => {
  ...
  const datatintuc= [
    {id :1,img:require('../../Media/image/Thumbnails_News_1.webp'), title: 'Tính năng AI trên iPhone 16: Những gì bạn cần biết', description: 'Gần đây, Apple đã công bố ngày tổ chức Hội nghị các nhà phát triển toàn cầu (WWDC24), nơi hãng sẽ chia sẻ thông tin mới về hệ điều hành của mình.  Theo nhiều nguồn tin, có khả năng Apple sẽ giới thiệu một số tính năng  AI mới cho dòng iPhone 16…', date:'11/11/2024'},
    {id :2,img:require('../../Media/image/Thumbnails_News_2.webp'), title: 'Nên tậu iPhone 16 bằng hình thức "mua trả chậm" không?', description: 'Gần đây, Apple đã công bố ngày tổ chức Hội nghị các nhà phát triển toàn cầu (WWDC24), nơi hãng sẽ chia sẻ thông tin mới về hệ điều hành của mình.  Theo nhiều nguồn tin, có khả năng Apple sẽ giới thiệu một số tính năng  AI mới cho dòng iPhone 16…', date:'24/11/2024'},
  ]
        ...
        renderItem={({ item }) => (
          <View style={styles.itemtintuc}>
            ...
            <View style={styles.tintuc_text}>
              ...
              <Text style={styles.tintuc_text_des}>
                {item.description}
              </Text>
