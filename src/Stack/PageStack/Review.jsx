...
const Review = ({navigation}) => {
  ...
  const datadanhgia = [
    {
      id: 1,
      img: require('../../Media/image/profile_avatar.jpg'),
      name: 'Brunal Ronaldo',
      date: '20/11/2024',
      cmt: 'Nice iPhone with good delivery. The delivery time is very fast. Then products look like exactly the picture in the app. Besides, color is also the same and quality is very good despite very cheap price',
    },
    {
      id: 2,
      img: require('../../Media/image/profile_avatar.jpg'),
    ...
    {
      id: 3,
      img: require('../../Media/image/Logo_App.png'),
      name: 'Malado',
      date: '14/12/2018',
      cmt: 'Nice iPhone with good delivery. The delivery time is very fast. Then products look like exactly the picture in the app. Besides, color is also the same and quality is very good despite very cheap price',
    },
