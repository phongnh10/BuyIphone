...
import { View, Text, FlatList, ScrollView, StyleSheet, TouchableOpacity, Image, TextInput } from 'react-native';
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.iconTim}>
                <Image source={require('../../Media/icon/icon_back.png')} style={styles.icon} />
                <TextInput
                    style={styles.input}
